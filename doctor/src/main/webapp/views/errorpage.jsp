  ...
  <div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
      ...
      <div class="navbar-nav w-100">
        <a href="<c:url value="/"/>" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
        ...
        <a href="<c:url value="/table"/>" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Tables</a>
    ...
    <div class="container-fluid pt-4 px-4">
      <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
        <div class="col-md-6 text-center p-4">
          ...
          <a class="btn btn-primary rounded-pill py-3 px-5" href="<c:url value="/"/>">Go Back To Home</a>
        </div>
      </div>
    </div>
    <!-- 404 End -->
