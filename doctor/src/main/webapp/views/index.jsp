            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<c:url value="/user/appointments"/>">Get</a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" role="button"
                                   aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">${sessionScope.doctor.doctorId}</span>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">${sessionScope.doctor.doctorName}</span>
                            </li>
                            <li class="nav-item dropdown no-arrow">
