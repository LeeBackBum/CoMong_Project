        ...
        <div class="container">
          <div class="row justify-content-start">
            <div class="col-sm-10 col-lg-8">
              <h5 class="text-primary text-uppercase mb-3 animated slideInUp">Best Online Courses</h5>
        ...
        <div class="container">
          <div class="row justify-content-start">
            <div class="col-sm-10 col-lg-8">
              ...
              <h1 class="display-3 text-white animated slideInDown">Get Medical Service Online From Your Home</h1>
              <p class="fs-5 text-white mb-4 pb-2">Vero elitr justo clita lorem. Ipsum dolor at sed stet sit diam no. Kasd rebum ipsum et diam justo clita et kasd rebum sea sanctus eirmod elitr.</p>
              <a href="<c:url value="/"/>" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Read More</a>
              <a href="<c:url value="/login"/>" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Join Now</a>
            </div>
