...
<script type="module">
    ...
    // 초기 카메라 위치 설정
    camera.position.set(136.91250579063043, 63.15034237796595, 54.90766367567109);

    // 카메라가 바라볼 목표 지점 계산 (Camera Position + Camera Direction)
    const direction = new THREE.Vector3(-7.654717102001883, -2.4576969650804728, -5.946850571197679);
